...
/**
 * This example calculates the performance of rocket engine at given altitude.
 *
 * Possible options:
...
int main(int argc, char* argv[]) {
	...
	printf("Is=%8.3f m/s, %8.3f s at H=%6.2f km (pa=%8.4f atm)\n", IsH, IsH/CONST_G, H/1000.0, pa/CONST_ATM);
